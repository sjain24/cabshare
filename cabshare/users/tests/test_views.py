...
from cabshare.users.models import User
from cabshare.users.tests.factories import UserFactory
from cabshare.users.views import UserRedirectView, UserUpdateView, user_detail_view
